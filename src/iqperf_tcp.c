 ...
 */
int
iqperf_tcp_recv(struct iqperf_stream *sp)
{
    int r;
 ...
 */
int
iqperf_tcp_send(struct iqperf_stream *sp)
{
    int r;
 ...
 */
int
iqperf_tcp_accept(struct iqperf_test * test)
{
    int     s;
 ...
 */
int
iqperf_tcp_listen(struct iqperf_test *test)
{
    int s, opt;
    socklen_t optlen;
    int saved_errno;
 ...
 */
int
iqperf_tcp_connect(struct iqperf_test *test)
{
