...
"""
Extract iqperf data from json blob and format for gnuplot.
"""
...
def generate_output(iqperf, options):
    """Do the actual formatting."""
    for i in iqperf.get('intervals'):
...
def summed_output(iqperf, options):
