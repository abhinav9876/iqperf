#
# sample Gnuplot command file for iqperf3 results
set term x11
#set term png 
...
set output "iqperf3.png"
#set output "iqperf3.eps"
...
#plot "iqperf3.old.dat" using 1:3 title '3.10 kernel' with linespoints lw 3 pt 5, \
#	 "iqperf3.new.dat" using 1:3 title '4.2 kernel' with linespoints lw 3 pt 7
