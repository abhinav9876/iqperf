...
#include "iqperf_udp.h"
#include "iqperf_tcp.h"
#if defined(HAVE_SCTP)
#include "iqperf_sctp.h"
#endif /* HAVE_SCTP */
#include "timer.h"

#include "cjson.h"
#include "units.h"
#include "iqperf_util.h"
#include "iqperf_locale.h"
#include "version.h"
#if defined(HAVE_SSL)
#include <openssl/bio.h>
#include "iqperf_auth.h"
#endif /* HAVE_SSL */

/* Forwards. */
static int send_parameters(struct iqperf_test *test);
static int get_parameters(struct iqperf_test *test);
static int send_results(struct iqperf_test *test);
static int get_results(struct iqperf_test *test);
static int diskfile_send(struct iqperf_stream *sp);
static int diskfile_recv(struct iqperf_stream *sp);
static int JSON_write(int fd, cJSON *json);
static void print_interval_results(struct iqperf_test *test, struct iqperf_stream *sp, cJSON *json_interval_streams);
...
int
iqperf_get_verbose(struct iqperf_test *ipt)
{
    return ipt->verbose;
}

int
iqperf_get_control_socket(struct iqperf_test *ipt)
{
    return ipt->ctrl_sck;
}

int
iqperf_get_control_socket_mss(struct iqperf_test *ipt)
{
    return ipt->ctrl_sck_mss;
}

int
iqperf_get_test_omit(struct iqperf_test *ipt)
{
    return ipt->omit;
}

int
iqperf_get_test_duration(struct iqperf_test *ipt)
{
    return ipt->duration;
}

uint64_t
iqperf_get_test_rate(struct iqperf_test *ipt)
{
    return ipt->settings->rate;
}

uint64_t
iqperf_get_test_fqrate(struct iqperf_test *ipt)
{
    return ipt->settings->fqrate;
}

int
iqperf_get_test_pacing_timer(struct iqperf_test *ipt)
{
    return ipt->settings->pacing_timer;
}

uint64_t
iqperf_get_test_bytes(struct iqperf_test *ipt)
{
    return (uint64_t) ipt->settings->bytes;
}

uint64_t
iqperf_get_test_blocks(struct iqperf_test *ipt)
{
    return (uint64_t) ipt->settings->blocks;
}

int
iqperf_get_test_burst(struct iqperf_test *ipt)
{
    return ipt->settings->burst;
}

char
iqperf_get_test_role(struct iqperf_test *ipt)
{
    return ipt->role;
}

int
iqperf_get_test_reverse(struct iqperf_test *ipt)
{
    return ipt->reverse;
}

int
iqperf_get_test_blksize(struct iqperf_test *ipt)
{
    return ipt->settings->blksize;
}

FILE *
iqperf_get_test_outfile (struct iqperf_test *ipt)
{
    return ipt->outfile;
}

int
iqperf_get_test_socket_bufsize(struct iqperf_test *ipt)
{
    return ipt->settings->socket_bufsize;
}

double
iqperf_get_test_reporter_interval(struct iqperf_test *ipt)
{
    return ipt->reporter_interval;
}

double
iqperf_get_test_stats_interval(struct iqperf_test *ipt)
{
    return ipt->stats_interval;
}

int
iqperf_get_test_num_streams(struct iqperf_test *ipt)
{
    return ipt->num_streams;
}

int
iqperf_get_test_server_port(struct iqperf_test *ipt)
{
    return ipt->server_port;
}

char*
iqperf_get_test_server_hostname(struct iqperf_test *ipt)
{
    return ipt->server_hostname;
}

char*
iqperf_get_test_template(struct iqperf_test *ipt)
{
    return ipt->tmp_template;
}

int
iqperf_get_test_protocol_id(struct iqperf_test *ipt)
{
    return ipt->protocol->id;
}

int
iqperf_get_test_json_output(struct iqperf_test *ipt)
{
    return ipt->json_output;
}

char *
iqperf_get_test_json_output_string(struct iqperf_test *ipt)
{
    return ipt->json_output_string;
}

int
iqperf_get_test_zerocopy(struct iqperf_test *ipt)
{
    return ipt->zerocopy;
}

int
iqperf_get_test_get_server_output(struct iqperf_test *ipt)
{
    return ipt->get_server_output;
}

char
iqperf_get_test_unit_format(struct iqperf_test *ipt)
{
    return ipt->settings->unit_format;
}

char *
iqperf_get_test_bind_address(struct iqperf_test *ipt)
{
    return ipt->bind_address;
}

int
iqperf_get_test_udp_counters_64bit(struct iqperf_test *ipt)
{
    return ipt->udp_counters_64bit;
}

int
iqperf_get_test_one_off(struct iqperf_test *ipt)
{
    return ipt->one_off;
}

int
iqperf_get_test_tos(struct iqperf_test *ipt)
{
    return ipt->settings->tos;
}

char *
iqperf_get_test_extra_data(struct iqperf_test *ipt)
{
    return ipt->extra_data;
}

static const char iqperf_version[] = iqperf_VERSION;
char *
iqperf_get_iqperf_version(void)
{
    return (char*)iqperf_version;
}

/************** Setter routines for some fields inside iqperf_test *************/

void
iqperf_set_verbose(struct iqperf_test *ipt, int verbose)
{
    ipt->verbose = verbose;
}

void
iqperf_set_control_socket(struct iqperf_test *ipt, int ctrl_sck)
{
    ipt->ctrl_sck = ctrl_sck;
}

void
iqperf_set_test_omit(struct iqperf_test *ipt, int omit)
{
    ipt->omit = omit;
}

void
iqperf_set_test_duration(struct iqperf_test *ipt, int duration)
{
    ipt->duration = duration;
}

void
iqperf_set_test_reporter_interval(struct iqperf_test *ipt, double reporter_interval)
{
    ipt->reporter_interval = reporter_interval;
}

void
iqperf_set_test_stats_interval(struct iqperf_test *ipt, double stats_interval)
{
    ipt->stats_interval = stats_interval;
}

void
iqperf_set_test_state(struct iqperf_test *ipt, signed char state)
{
    ipt->state = state;
}

void
iqperf_set_test_blksize(struct iqperf_test *ipt, int blksize)
{
    ipt->settings->blksize = blksize;
}

void
iqperf_set_test_rate(struct iqperf_test *ipt, uint64_t rate)
{
    ipt->settings->rate = rate;
}

void
iqperf_set_test_fqrate(struct iqperf_test *ipt, uint64_t fqrate)
{
    ipt->settings->fqrate = fqrate;
}

void
iqperf_set_test_pacing_timer(struct iqperf_test *ipt, int pacing_timer)
{
    ipt->settings->pacing_timer = pacing_timer;
}

void
iqperf_set_test_bytes(struct iqperf_test *ipt, uint64_t bytes)
{
    ipt->settings->bytes = (iqperf_size_t) bytes;
}

void
iqperf_set_test_blocks(struct iqperf_test *ipt, uint64_t blocks)
{
    ipt->settings->blocks = (iqperf_size_t) blocks;
}

void
iqperf_set_test_burst(struct iqperf_test *ipt, int burst)
{
    ipt->settings->burst = burst;
}

void
iqperf_set_test_server_port(struct iqperf_test *ipt, int srv_port)
{
    ipt->server_port = srv_port;
}

void
iqperf_set_test_socket_bufsize(struct iqperf_test *ipt, int socket_bufsize)
{
    ipt->settings->socket_bufsize = socket_bufsize;
}

void
iqperf_set_test_num_streams(struct iqperf_test *ipt, int num_streams)
{
    ipt->num_streams = num_streams;
}

static void
check_sender_has_retransmits(struct iqperf_test *ipt)
{
...
void
iqperf_set_test_role(struct iqperf_test *ipt, char role)
{
    ipt->role = role;
    if (role == 'c')
	ipt->sender = 1;
...
void
iqperf_set_test_server_hostname(struct iqperf_test *ipt, char *server_hostname)
{
    ipt->server_hostname = strdup(server_hostname);
}

void
iqperf_set_test_template(struct iqperf_test *ipt, char *tmp_template)
{
    ipt->tmp_template = strdup(tmp_template);
}

void
iqperf_set_test_reverse(struct iqperf_test *ipt, int reverse)
{
    ipt->reverse = reverse;
    if (ipt->role == 'c')
        ipt->sender = 1;
...
void
iqperf_set_test_json_output(struct iqperf_test *ipt, int json_output)
{
    ipt->json_output = json_output;
}

int
iqperf_has_zerocopy( void )
{
    return has_sendfile();
}

void
iqperf_set_test_zerocopy(struct iqperf_test *ipt, int zerocopy)
{
    ipt->zerocopy = (zerocopy && has_sendfile());
}

void
iqperf_set_test_get_server_output(struct iqperf_test *ipt, int get_server_output)
{
    ipt->get_server_output = get_server_output;
}

void
iqperf_set_test_unit_format(struct iqperf_test *ipt, char unit_format)
{
...
#if defined(HAVE_SSL)
void
iqperf_set_test_client_username(struct iqperf_test *ipt, char *client_username)
{
    ipt->settings->client_username = client_username;
}

void
iqperf_set_test_client_password(struct iqperf_test *ipt, char *client_password)
{
    ipt->settings->client_password = client_password;
}

void
iqperf_set_test_client_rsa_pubkey(struct iqperf_test *ipt, char *client_rsa_pubkey_base64)
{
...
void
iqperf_set_test_bind_address(struct iqperf_test *ipt, char *bnd_address)
{
    ipt->bind_address = strdup(bnd_address);
}

void
iqperf_set_test_udp_counters_64bit(struct iqperf_test *ipt, int udp_counters_64bit)
{
    ipt->udp_counters_64bit = udp_counters_64bit;
}

void
iqperf_set_test_one_off(struct iqperf_test *ipt, int one_off)
{
    ipt->one_off = one_off;
}

void
iqperf_set_test_tos(struct iqperf_test *ipt, int tos)
{
    ipt->settings->tos = tos;
}

void
iqperf_set_test_extra_data(struct iqperf_test *ipt, char *dat)
{
    ipt->extra_data = dat;
}
...
struct protocol *
get_protocol(struct iqperf_test *test, int prot_id)
{
...
int
set_protocol(struct iqperf_test *test, int prot_id)
{
...
/************************** iqperf callback functions **************************/

void
iqperf_on_new_stream(struct iqperf_stream *sp)
{
    connect_msg(sp);
}

void
iqperf_on_test_start(struct iqperf_test *test)
{
    if (test->json_output) {
	cJSON_AddItemToObject(test->json_start, "test_start", iqperf_json_printf("protocol: %s  num_streams: %d  blksize: %d  omit: %d  duration: %d  bytes: %d  blocks: %d  reverse: %d  tos: %d", test->protocol->name, (int64_t) test->num_streams, (int64_t) test->settings->blksize, (int64_t) test->omit, (int64_t) test->duration, (int64_t) test->settings->bytes, (int64_t) test->settings->blocks, test->reverse?(int64_t)1:(int64_t)0, (int64_t) test->settings->tos));
    } else {
	if (test->verbose) {
	    if (test->settings->bytes)
		iqperf_printf(test, test_start_bytes, test->protocol->name, test->num_streams, test->settings->blksize, test->omit, test->settings->bytes, test->settings->tos);
	    else if (test->settings->blocks)
		iqperf_printf(test, test_start_blocks, test->protocol->name, test->num_streams, test->settings->blksize, test->omit, test->settings->blocks, test->settings->tos);
	    else
		iqperf_printf(test, test_start_time, test->protocol->name, test->num_streams, test->settings->blksize, test->omit, test->duration, test->settings->tos);
	}
    }
}
...
void
iqperf_on_connect(struct iqperf_test *test)
{
    time_t now_secs;
    ...
    if (test->json_output)
	cJSON_AddItemToObject(test->json_start, "timestamp", iqperf_json_printf("time: %s  timesecs: %d", now_str, (int64_t) now_secs));
    else if (test->verbose)
	iqperf_printf(test, report_time, now_str);

    if (test->role == 'c') {
	if (test->json_output)
	    cJSON_AddItemToObject(test->json_start, "connecting_to", iqperf_json_printf("host: %s  port: %d", test->server_hostname, (int64_t) test->server_port));
	else {
	    iqperf_printf(test, report_connecting, test->server_hostname, test->server_port);
	    if (test->reverse)
		iqperf_printf(test, report_reverse, test->server_hostname);
	}
    } else {
        len = sizeof(sa);
	...
	if (test->json_output)
	    cJSON_AddItemToObject(test->json_start, "accepted_connection", iqperf_json_printf("host: %s  port: %d", ipr, (int64_t) port));
	else
	    iqperf_printf(test, report_accepted, ipr, port);
    }
    if (test->json_output) {
	cJSON_AddStringToObject(test->json_start, "cookie", test->cookie);
        ...
        iqperf_printf(test, report_cookie, test->cookie);
        if (test->protocol->id == SOCK_STREAM) {
            if (test->settings->mss)
                iqperf_printf(test, "      TCP MSS: %d\n", test->settings->mss);
            else {
                iqperf_printf(test, "      TCP MSS: %d (default)\n", test->ctrl_sck_mss);
            }
        }
...
void
iqperf_on_test_finish(struct iqperf_test *test)
{
}
...
int
iqperf_parse_arguments(struct iqperf_test *test, int argc, char **argv)
{
    ...
    while ((flag = getopt_long(argc, argv, "p:f:i:D1VJvsc:ub:t:n:k:l:P:Rw:B:M:N46S:L:ZO:F:A:T:C:dI:hX:", longopts, NULL)) != -1) {
		...
		iqperf_set_test_server_hostname(test, optarg);
                break;
            case 'u':
		...
		client_flag = 1;
                break;
            case 'R':
		iqperf_set_test_reverse(test, 1);
		client_flag = 1;
                break;
            case 'w':
    ...
    if (test->role == 's' && (client_username || client_rsa_public_key)){
        ...
        size_t s;
        if (iqperf_getpass(&client_password, &s, stdin) < 0){
            return -1;
        } 
...
int
iqperf_set_send_state(struct iqperf_test *test, signed char state)
{
    test->state = state;
...
void
iqperf_check_throttle(struct iqperf_stream *sp, struct timeval *nowP)
{
    double seconds;
...
int
iqperf_send(struct iqperf_test *test, fd_set *write_setP)
{
    register int multisend, r, streams_active;
    register struct iqperf_stream *sp;
    struct timeval now;
...
int
iqperf_recv(struct iqperf_test *test, fd_set *read_setP)
{
    int r;
    struct iqperf_stream *sp;
...
int
iqperf_init_test(struct iqperf_test *test)
{
    struct timeval now;
    struct iqperf_stream *sp;
...
{
    struct iqperf_stream *sp = client_data.p;
    ...
    ** checking the flag.
    */
    iqperf_check_throttle(sp, nowP);
}

int
iqperf_create_send_timers(struct iqperf_test * test)
{
    struct timeval now;
    struct iqperf_stream *sp;
    TimerClientData cd;
...
#if defined(HAVE_SSL)
int test_is_authorized(struct iqperf_test *test){
    ...
    if (test->settings->authtoken){
        ...
        if (ret == 0){
            iqperf_printf(test, report_authetication_successed, username, ts);
            return 0;
        } else {
            iqperf_printf(test, report_authetication_failed, username, ts);
            return -1;
        }
    }
    return -1;
...
/**
 * iqperf_exchange_parameters - handles the param_Exchange part for client
 *
 */

int
iqperf_exchange_parameters(struct iqperf_test *test)
{
    int s;
    int32_t err;
    ...
    if (test->role == 'c') {
        ...
        if (test_is_authorized(test) < 0){
            if (iqperf_set_send_state(test, SERVER_ERROR) != 0)
                return -1;
            i_errno = IEAUTHTEST;
            err = htonl(i_errno);
	...
	if (iqperf_set_send_state(test, CREATE_STREAMS) != 0)
            return -1;
...
int
iqperf_exchange_results(struct iqperf_test *test)
{
    if (test->role == 'c') {
...
static int
send_parameters(struct iqperf_test *test)
{
    int r = 0;
    cJSON *j;
	...
	if (test->get_server_output)
	    cJSON_AddNumberToObject(j, "get_server_output", iqperf_get_test_get_server_output(test));
	if (test->udp_counters_64bit)
	    cJSON_AddNumberToObject(j, "udp_counters_64bit", iqperf_get_test_udp_counters_64bit(test));
#if defined(HAVE_SSL)
...
#endif // HAVE_SSL
	cJSON_AddStringToObject(j, "client_version", iqperf_VERSION);
...
static int
get_parameters(struct iqperf_test *test)
{
    int r = 0;
    cJSON *j;
    cJSON *j_p;
	...
	if ((j_p = cJSON_GetObjectItem(j, "get_server_output")) != NULL)
	    iqperf_set_test_get_server_output(test, 1);
	if ((j_p = cJSON_GetObjectItem(j, "udp_counters_64bit")) != NULL)
	    iqperf_set_test_udp_counters_64bit(test, 1);
#if defined(HAVE_SSL)
...
static int
send_results(struct iqperf_test *test)
{
    int r = 0;
    cJSON *j;
    cJSON *j_streams;
    ...
    iqperf_size_t bytes_transferred;
    int retransmits;
...
static int
get_results(struct iqperf_test *test)
{
    int r = 0;
    cJSON *j;
	...
	if (j_cpu_util_total == NULL || j_cpu_util_user == NULL || j_cpu_util_system == NULL || j_sender_has_retransmits == NULL) {
		 ...
		 */
		if (test->role == 'c' && iqperf_get_test_get_server_output(test)) {
...
void
add_to_interval_list(struct iqperf_stream_result * rp, struct iqperf_interval_results * new)
{
    struct iqperf_interval_results *irp;

    irp = (struct iqperf_interval_results *) malloc(sizeof(struct iqperf_interval_results));
    memcpy(irp, new, sizeof(struct iqperf_interval_results));
...
void
connect_msg(struct iqperf_stream *sp)
{
    ...
    if (sp->test->json_output)
        cJSON_AddItemToArray(sp->test->json_connected, iqperf_json_printf("socket: %d  local_host: %s  local_port: %d  remote_host: %s  remote_port: %d", (int64_t) sp->socket, ipl, (int64_t) lport, ipr, (int64_t) rport));
    else
	iqperf_printf(sp->test, report_connected, sp->socket, ipl, lport, ipr, rport);
}
...
iqperf_new_test()
{
    ...
    test = (struct iqperf_test *) malloc(sizeof(struct iqperf_test));
    if (!test) {
        i_errno = IENEWTEST;
        return NULL;
    }
    /* initialize everything to zero */
    memset(test, 0, sizeof(struct iqperf_test));

    test->settings = (struct iqperf_settings *) malloc(sizeof(struct iqperf_settings));
    if (!test->settings) {
        free(test);
	i_errno = IENEWTEST;
	return NULL;
    }
    memset(test->settings, 0, sizeof(struct iqperf_settings));
...
/**************************************************************************/
int
iqperf_defaults(struct iqperf_test *testp)
{
    ...
    testp->stats_callback = iqperf_stats_callback;
    testp->reporter_callback = iqperf_reporter_callback;
    ...
    tcp->id = Ptcp;
    tcp->name = "TCP";
    tcp->accept = iqperf_tcp_accept;
    tcp->listen = iqperf_tcp_listen;
    tcp->connect = iqperf_tcp_connect;
    tcp->send = iqperf_tcp_send;
    tcp->recv = iqperf_tcp_recv;
    tcp->init = NULL;
    ...
    udp->id = Pudp;
    udp->name = "UDP";
    udp->accept = iqperf_udp_accept;
    udp->listen = iqperf_udp_listen;
    udp->connect = iqperf_udp_connect;
    udp->send = iqperf_udp_send;
    udp->recv = iqperf_udp_recv;
    udp->init = iqperf_udp_init;
    ...
    sctp->id = Psctp;
    sctp->name = "SCTP";
    sctp->accept = iqperf_sctp_accept;
    sctp->listen = iqperf_sctp_listen;
    sctp->connect = iqperf_sctp_connect;
    sctp->send = iqperf_sctp_send;
    sctp->recv = iqperf_sctp_recv;
    sctp->init = iqperf_sctp_init;

    SLIST_INSERT_AFTER(udp, sctp, protocols);
#endif /* HAVE_SCTP */

    testp->on_new_stream = iqperf_on_new_stream;
    testp->on_test_start = iqperf_on_test_start;
    testp->on_connect = iqperf_on_connect;
    testp->on_test_finish = iqperf_on_test_finish;
...
/**************************************************************************/
void
iqperf_free_test(struct iqperf_test *test)
{
    struct protocol *prot;
    struct iqperf_stream *sp;
...
void
iqperf_reset_test(struct iqperf_test *test)
{
    struct iqperf_stream *sp;
...
*/
void
iqperf_reset_stats(struct iqperf_test *test)
{
    struct timeval now;
    struct iqperf_stream *sp;
    struct iqperf_stream_result *rp;
	...
	if (test->sender_has_retransmits == 1) {
	    struct iqperf_interval_results ir; /* temporary results structure */
	    save_tcpinfo(sp, &ir);
 ...
 */
void
iqperf_stats_callback(struct iqperf_test *test)
{
    struct iqperf_stream *sp;
    struct iqperf_stream_result *rp = NULL;
    struct iqperf_interval_results *irp, temp;
 ...
 */
static void
iqperf_print_intermediate(struct iqperf_test *test)
{
    char ubuf[UNIT_LEN];
    char nbuf[UNIT_LEN];
    struct iqperf_stream *sp = NULL;
    struct iqperf_interval_results *irp;
    iqperf_size_t bytes = 0;
    double bandwidth;
    int retransmits = 0;
    double start_time, end_time;
    cJSON *json_interval;
	...
	irp = TAILQ_LAST(&sp->result->interval_results, irlisthead);
	if (irp == NULL) {
	    iqperf_err(test, "iqperf_print_intermediate error: interval_results is NULL");
	    return;
	}
	...
	if (test->protocol->id == Ptcp || test->protocol->id == Psctp) {
		...
		if (test->json_output)
		    cJSON_AddItemToObject(json_interval, "sum", iqperf_json_printf("start: %f  end: %f  seconds: %f  bytes: %d  bits_per_second: %f  retransmits: %d  omitted: %b", (double) start_time, (double) end_time, (double) irp->interval_duration, (int64_t) bytes, bandwidth * 8, (int64_t) retransmits, irp->omitted)); /* XXX irp->omitted or test->omitting? */
		else
		    iqperf_printf(test, report_sum_bw_retrans_format, start_time, end_time, ubuf, nbuf, retransmits, irp->omitted?report_omitted:""); /* XXX irp->omitted or test->omitting? */
	    } else {
		/* Interval sum, TCP without retransmits. */
		if (test->json_output)
		    cJSON_AddItemToObject(json_interval, "sum", iqperf_json_printf("start: %f  end: %f  seconds: %f  bytes: %d  bits_per_second: %f  omitted: %b", (double) start_time, (double) end_time, (double) irp->interval_duration, (int64_t) bytes, bandwidth * 8, test->omitting));
		else
		    iqperf_printf(test, report_sum_bw_format, start_time, end_time, ubuf, nbuf, test->omitting?report_omitted:"");
	    }
	} else {
	    /* Interval sum, UDP. */
	    if (test->sender) {
		if (test->json_output)
		    cJSON_AddItemToObject(json_interval, "sum", iqperf_json_printf("start: %f  end: %f  seconds: %f  bytes: %d  bits_per_second: %f  packets: %d  omitted: %b", (double) start_time, (double) end_time, (double) irp->interval_duration, (int64_t) bytes, bandwidth * 8, (int64_t) total_packets, test->omitting));
		else
		    iqperf_printf(test, report_sum_bw_udp_sender_format, start_time, end_time, ubuf, nbuf, total_packets, test->omitting?report_omitted:"");
	    } else {
		...
		if (test->json_output)
		    cJSON_AddItemToObject(json_interval, "sum", iqperf_json_printf("start: %f  end: %f  seconds: %f  bytes: %d  bits_per_second: %f  jitter_ms: %f  lost_packets: %d  packets: %d  lost_percent: %f  omitted: %b", (double) start_time, (double) end_time, (double) irp->interval_duration, (int64_t) bytes, bandwidth * 8, (double) avg_jitter * 1000.0, (int64_t) lost_packets, (int64_t) total_packets, (double) lost_percent, test->omitting));
		else
		    iqperf_printf(test, report_sum_bw_udp_format, start_time, end_time, ubuf, nbuf, avg_jitter * 1000.0, lost_packets, total_packets, lost_percent, test->omitting?report_omitted:"");
	    }
	}
	}
    }
 ...
 */
static void
iqperf_print_results(struct iqperf_test *test)
{
    ...
    char sbuf[UNIT_LEN];
    struct iqperf_stream *sp = NULL;
    iqperf_size_t bytes_sent, total_sent = 0;
    iqperf_size_t bytes_received, total_received = 0;
	...
	iqperf_printf(test, "%s", report_bw_separator);
	if (test->verbose)
	    iqperf_printf(test, "%s", report_summary);
	if (test->protocol->id == Ptcp || test->protocol->id == Psctp) {
	    if (test->sender_has_retransmits)
		iqperf_printf(test, "%s", report_bw_retrans_header);
	    else
		iqperf_printf(test, "%s", report_bw_header);
	} else
	    iqperf_printf(test, "%s", report_bw_udp_header);
    }
     ...
     * and receiver ending times.  Earlier iqperf (3.1 and earlier)
     ...
     * basically emulating what iqperf 3.1 did.
     */
    if (sp) {
    end_time = timeval_diff(&sp->result->start_time, &sp->result->end_time);
    if (test->sender) {
	...
	if (test->protocol->id == Ptcp || test->protocol->id == Psctp) {
		...
		if (test->json_output)
		    cJSON_AddItemToObject(json_summary_stream, "sender", iqperf_json_printf("socket: %d  start: %f  end: %f  seconds: %f  bytes: %d  bits_per_second: %f  retransmits: %d  max_snd_cwnd:  %d  max_rtt:  %d  min_rtt:  %d  mean_rtt:  %d", (int64_t) sp->socket, (double) start_time, (double) sender_time, (double) sender_time, (int64_t) bytes_sent, bandwidth * 8, (int64_t) sp->result->stream_retrans, (int64_t) sp->result->stream_max_snd_cwnd, (int64_t) sp->result->stream_max_rtt, (int64_t) sp->result->stream_min_rtt, (int64_t) ((sp->result->stream_count_rtt == 0) ? 0 : sp->result->stream_sum_rtt / sp->result->stream_count_rtt)));
		else
		    if (test->role == 's' && !test->sender) {
			if (test->verbose) 
			    iqperf_printf(test, report_sender_not_available_format, sp->socket);
		    }
		    else {
			iqperf_printf(test, report_bw_retrans_format, sp->socket, start_time, sender_time, ubuf, nbuf, sp->result->stream_retrans, report_sender);
		    }
	    } else {
		/* Sender summary, TCP and SCTP without retransmits. */
		if (test->json_output)
		    cJSON_AddItemToObject(json_summary_stream, "sender", iqperf_json_printf("socket: %d  start: %f  end: %f  seconds: %f  bytes: %d  bits_per_second: %f", (int64_t) sp->socket, (double) start_time, (double) sender_time, (double) sender_time, (int64_t) bytes_sent, bandwidth * 8));
		else
		    if (test->role == 's' && !test->sender) {
			if (test->verbose)
			    iqperf_printf(test, report_sender_not_available_format, sp->socket);
			...
			iqperf_printf(test, report_bw_format, sp->socket, start_time, sender_time, ubuf, nbuf, report_sender);
		    }
	    }
	} else {
	    /* Sender summary, UDP. */
		 ...
		 */
		int packet_count = sender_packet_count ? sender_packet_count : receiver_packet_count;
		cJSON_AddItemToObject(json_summary_stream, "udp", iqperf_json_printf("socket: %d  start: %f  end: %f  seconds: %f  bytes: %d  bits_per_second: %f  jitter_ms: %f  lost_packets: %d  packets: %d  lost_percent: %f  out_of_order: %d", (int64_t) sp->socket, (double) start_time, (double) sender_time, (double) sender_time, (int64_t) bytes_sent, bandwidth * 8, (double) sp->jitter * 1000.0, (int64_t) (sp->cnt_error - sp->omitted_cnt_error), (int64_t) (packet_count - sp->omitted_packet_count), (double) lost_percent, (int64_t) (sp->outoforder_packets - sp->omitted_outoforder_packets)));
	    }
	    else {
		/*
		...
		if (test->role == 's' && !test->sender) {
		    ...
		    iqperf_printf(test, report_bw_udp_format, sp->socket, start_time, sender_time, ubuf, nbuf, 0.0, 0, (sender_packet_count - sp->omitted_packet_count), (double) 0, report_sender);
		}
		if ((sp->outoforder_packets - sp->omitted_outoforder_packets) > 0)
                  iqperf_printf(test, report_sum_outoforder, start_time, sender_time, (sp->outoforder_packets - sp->omitted_outoforder_packets));
	    }
	}
	...
	if (sp->diskfile_fd >= 0) {
		...
		if (test->json_output)
		    cJSON_AddItemToObject(json_summary_stream, "diskfile", iqperf_json_printf("sent: %d  received: %d  size: %d  percent_sent: %d  percent_received: %d  filename: %s", (int64_t) bytes_sent, (int64_t) bytes_received, (int64_t) sb.st_size, (int64_t) percent_sent, (int64_t) percent_received, test->diskfile_name));
		else
		    if (test->sender) {
			iqperf_printf(test, report_diskfile, ubuf, sbuf, percent_sent, test->diskfile_name);
		    }
		    else {
			unit_snprintf(ubuf, UNIT_LEN, (double) bytes_received, 'A');
			iqperf_printf(test, report_diskfile, ubuf, sbuf, percent_received, test->diskfile_name);
		    }
	    }
	}
	...
	if (test->protocol->id == Ptcp || test->protocol->id == Psctp) {
	    ...
	    if (test->json_output)
		cJSON_AddItemToObject(json_summary_stream, "receiver", iqperf_json_printf("socket: %d  start: %f  end: %f  seconds: %f  bytes: %d  bits_per_second: %f", (int64_t) sp->socket, (double) start_time, (double) receiver_time, (double) end_time, (int64_t) bytes_received, bandwidth * 8));
	    else
		if (test->role == 's' && test->sender) {
		    if (test->verbose) 
			iqperf_printf(test, report_receiver_not_available_format, sp->socket);
		}
		else {
		    iqperf_printf(test, report_bw_format, sp->socket, start_time, receiver_time, ubuf, nbuf, report_receiver);
		}
	}
	else {
	    /* 
		...
		if (test->role == 's' && test->sender) {
		    ...
		    iqperf_printf(test, report_bw_udp_format, sp->socket, start_time, receiver_time, ubuf, nbuf, sp->jitter * 1000.0, (sp->cnt_error - sp->omitted_cnt_error), (receiver_packet_count - sp->omitted_packet_count), lost_percent, report_receiver);
		}
	    }
	}
    }
	...
	if (sender_time > 0.0) {
		...
		if (test->json_output)
		    cJSON_AddItemToObject(test->json_end, "sum_sent", iqperf_json_printf("start: %f  end: %f  seconds: %f  bytes: %d  bits_per_second: %f  retransmits: %d", (double) start_time, (double) sender_time, (double) sender_time, (int64_t) total_sent, bandwidth * 8, (int64_t) total_retransmits));
		else
		    if (test->role == 's' && !test->sender) {
		        if (test->verbose)
			    iqperf_printf(test, report_sender_not_available_summary_format, "SUM");
		    }
		    else {
		      iqperf_printf(test, report_sum_bw_retrans_format, start_time, sender_time, ubuf, nbuf, total_retransmits, report_sender);
		    }
	    } else {
		/* Summary sum, TCP without retransmits. */
		if (test->json_output)
		    cJSON_AddItemToObject(test->json_end, "sum_sent", iqperf_json_printf("start: %f  end: %f  seconds: %f  bytes: %d  bits_per_second: %f", (double) start_time, (double) sender_time, (double) sender_time, (int64_t) total_sent, bandwidth * 8));
		else
		    if (test->role == 's' && !test->sender) {
		        if (test->verbose) 
			    iqperf_printf(test, report_sender_not_available_summary_format, "SUM");
		        ...
		        iqperf_printf(test, report_sum_bw_format, start_time, sender_time, ubuf, nbuf, report_sender);
		    }
	    }
		...
		bandwidth = 0.0;
            ...
            unit_snprintf(nbuf, UNIT_LEN, bandwidth, test->settings->unit_format);
	    if (test->json_output)
		cJSON_AddItemToObject(test->json_end, "sum_received", iqperf_json_printf("start: %f  end: %f  seconds: %f  bytes: %d  bits_per_second: %f", (double) start_time, (double) receiver_time, (double) receiver_time, (int64_t) total_received, bandwidth * 8));
	    else
	        if (test->role == 's' && test->sender) {
		    if (test->verbose) 
		        iqperf_printf(test, report_receiver_not_available_summary_format, "SUM");
		}
		else {
		    iqperf_printf(test, report_sum_bw_format, start_time, receiver_time, ubuf, nbuf, report_receiver);
	        }
        } else {
	    /* Summary sum, UDP. */
            avg_jitter /= test->num_streams;
	    ...
	    if (test->json_output)
		cJSON_AddItemToObject(test->json_end, "sum", iqperf_json_printf("start: %f  end: %f  seconds: %f  bytes: %d  bits_per_second: %f  jitter_ms: %f  lost_packets: %d  packets: %d  lost_percent: %f", (double) start_time, (double) receiver_time, (double) receiver_time, (int64_t) total_sent, bandwidth * 8, (double) avg_jitter * 1000.0, (int64_t) lost_packets, (int64_t) total_packets, (double) lost_percent));
	    else {
		/*
		...
		if (! (test->role == 's' && !test->sender) ) {
		    unit_snprintf(ubuf, UNIT_LEN, (double) total_sent, 'A');
		    iqperf_printf(test, report_sum_bw_udp_format, start_time, sender_time, ubuf, nbuf, 0.0, 0, sender_total_packets, 0.0, "sender");
		}
		if (! (test->role == 's' && test->sender) ) {
		    ...
		    unit_snprintf(nbuf, UNIT_LEN, bandwidth, test->settings->unit_format);
		    iqperf_printf(test, report_sum_bw_udp_format, start_time, receiver_time, ubuf, nbuf, avg_jitter * 1000.0, lost_packets, receiver_total_packets, lost_percent, "receiver");
		}
	    }
        }
    }
    ...
    if (test->json_output) {
	cJSON_AddItemToObject(test->json_end, "cpu_utilization_percent", iqperf_json_printf("host_total: %f  host_user: %f  host_system: %f  remote_total: %f  remote_user: %f  remote_system: %f", (double) test->cpu_util[0], (double) test->cpu_util[1], (double) test->cpu_util[2], (double) test->remote_cpu_util[0], (double) test->remote_cpu_util[1], (double) test->remote_cpu_util[2]));
	if (test->protocol->id == Ptcp) {
	...
	if (test->verbose) {
	    iqperf_printf(test, report_cpu, report_local, test->sender?report_sender:report_receiver, test->cpu_util[0], test->cpu_util[1], test->cpu_util[2], report_remote, test->sender?report_receiver:report_sender, test->remote_cpu_util[0], test->remote_cpu_util[1], test->remote_cpu_util[2]);
		...
		if (snd_congestion) {
		    iqperf_printf(test, "snd_tcp_congestion %s\n", snd_congestion);
		}
		if (rcv_congestion) {
		    iqperf_printf(test, "rcv_tcp_congestion %s\n", rcv_congestion);
		}
	    }
	}
 ...
 */
void
iqperf_reporter_callback(struct iqperf_test *test)
{
    switch (test->state) {
        case TEST_RUNNING:
        case STREAM_RUNNING:
            /* print interval results for each stream */
            iqperf_print_intermediate(test);
            break;
        case TEST_END:
        case DISPLAY_RESULTS:
            iqperf_print_intermediate(test);
            iqperf_print_results(test);
            break;
    } 
 ...
 */
static void
print_interval_results(struct iqperf_test *test, struct iqperf_stream *sp, cJSON *json_interval_streams)
{
    char ubuf[UNIT_LEN];
    char nbuf[UNIT_LEN];
    char cbuf[UNIT_LEN];
    double st = 0., et = 0.;
    struct iqperf_interval_results *irp = NULL;
    double bandwidth, lost_percent;

    irp = TAILQ_LAST(&sp->result->interval_results, irlisthead); /* get last entry in linked list */
    if (irp == NULL) {
	iqperf_err(test, "print_interval_results error: interval_results is NULL");
        return;
    }
    if (!test->json_output) {
	/* First stream? */
	if (sp == SLIST_FIRST(&test->streams)) {
	    ...
	    */
		...
		if (test->protocol->id == Ptcp || test->protocol->id == Psctp) {
		    if (test->sender_has_retransmits == 1)
			iqperf_printf(test, "%s", report_bw_retrans_cwnd_header);
		    else
			iqperf_printf(test, "%s", report_bw_header);
		} else {
		    if (test->sender)
			iqperf_printf(test, "%s", report_bw_udp_sender_header);
		    else
			iqperf_printf(test, "%s", report_bw_udp_header);
		}
	...
	if (test->sender_has_retransmits == 1) {
	    ...
	    if (test->json_output)
		cJSON_AddItemToArray(json_interval_streams, iqperf_json_printf("socket: %d  start: %f  end: %f  seconds: %f  bytes: %d  bits_per_second: %f  retransmits: %d  snd_cwnd:  %d  rtt:  %d  rttvar: %d  pmtu: %d  omitted: %b", (int64_t) sp->socket, (double) st, (double) et, (double) irp->interval_duration, (int64_t) irp->bytes_transferred, bandwidth * 8, (int64_t) irp->interval_retrans, (int64_t) irp->snd_cwnd, (int64_t) irp->rtt, (int64_t) irp->rttvar, (int64_t) irp->pmtu, irp->omitted));
	    else {
		unit_snprintf(cbuf, UNIT_LEN, irp->snd_cwnd, 'A');
		iqperf_printf(test, report_bw_retrans_cwnd_format, sp->socket, st, et, ubuf, nbuf, irp->interval_retrans, cbuf, irp->omitted?report_omitted:"");
	    }
	} else {
	    /* Interval, TCP without retransmits. */
	    if (test->json_output)
		cJSON_AddItemToArray(json_interval_streams, iqperf_json_printf("socket: %d  start: %f  end: %f  seconds: %f  bytes: %d  bits_per_second: %f  omitted: %b", (int64_t) sp->socket, (double) st, (double) et, (double) irp->interval_duration, (int64_t) irp->bytes_transferred, bandwidth * 8, irp->omitted));
	    else
		iqperf_printf(test, report_bw_format, sp->socket, st, et, ubuf, nbuf, irp->omitted?report_omitted:"");
	}
    } else {
	/* Interval, UDP. */
	if (test->sender) {
	    if (test->json_output)
		cJSON_AddItemToArray(json_interval_streams, iqperf_json_printf("socket: %d  start: %f  end: %f  seconds: %f  bytes: %d  bits_per_second: %f  packets: %d  omitted: %b", (int64_t) sp->socket, (double) st, (double) et, (double) irp->interval_duration, (int64_t) irp->bytes_transferred, bandwidth * 8, (int64_t) irp->interval_packet_count, irp->omitted));
	    else
		iqperf_printf(test, report_bw_udp_sender_format, sp->socket, st, et, ubuf, nbuf, irp->interval_packet_count, irp->omitted?report_omitted:"");
	} else {
		...
		iqperf_printf(test, report_bw_udp_format, sp->socket, st, et, ubuf, nbuf, irp->jitter * 1000.0, irp->interval_cnt_error, irp->interval_packet_count, lost_percent, irp->omitted?report_omitted:"");
	}
    }
...
/**************************************************************************/
void
iqperf_free_stream(struct iqperf_stream *sp)
{
    struct iqperf_interval_results *irp, *nirp;
...
iqperf_new_stream(struct iqperf_test *test, int s)
{
    struct iqperf_stream *sp;
    int ret = 0;
    ...
    if (test->tmp_template) {
        ...
        snprintf(template, sizeof(template) / sizeof(char), "%s/iqperf3.XXXXXX", tempdir);
    }

    sp = (struct iqperf_stream *) malloc(sizeof(struct iqperf_stream));
    if (!sp) {
        i_errno = IECREATESTREAM;
        return NULL;
    }

    memset(sp, 0, sizeof(struct iqperf_stream));

    sp->test = test;
    sp->settings = test->settings;
    sp->result = (struct iqperf_stream_result *) malloc(sizeof(struct iqperf_stream_result));
    if (!sp->result) {
        free(sp);
        i_errno = IECREATESTREAM;
        return NULL;
    ...
    memset(sp->result, 0, sizeof(struct iqperf_stream_result));
    ...
    if ((ret < 0) || (iqperf_init_stream(sp, test) < 0)) {
        close(sp->buffer_fd);
        munmap(sp->buffer, sp->test->settings->blksize);
        free(sp->result);
        free(sp);
...
/**************************************************************************/
int
iqperf_init_stream(struct iqperf_stream *sp, struct iqperf_test *test)
{
    socklen_t len;
    int opt;
...
/**************************************************************************/
void
iqperf_add_stream(struct iqperf_test *test, struct iqperf_stream *sp)
{
    int i;
    struct iqperf_stream *n, *prev;
...
static int
diskfile_send(struct iqperf_stream *sp)
{
    int r;
    static int rtot;
...
static int
diskfile_recv(struct iqperf_stream *sp)
{
    int r;
...
void
iqperf_catch_sigend(void (*handler)(int))
{
 ...
 */
void
iqperf_got_sigend(struct iqperf_test *test)
{
    /*
    ...
    iqperf_errexit(test, "interrupt - %s", iqperf_strerror(i_errno));
}

/* Try to write a PID file if requested, return -1 on an error. */
int
iqperf_create_pidfile(struct iqperf_test *test)
{
    if (test->pidfile) {
	int fd;
	char buf[8];
	...
	if (fd >= 0) {
		...
		if (pid > 0) {
			...
			free(test->pidfile);
			test->pidfile = NULL;
			iqperf_errexit(test, "Another instance of iqperf3 appears to be running");
		    }
		}
	    }
	}
...
int
iqperf_delete_pidfile(struct iqperf_test *test)
{
    if (test->pidfile) {
...
int
iqperf_json_start(struct iqperf_test *test)
{
...
int
iqperf_json_finish(struct iqperf_test *test)
{
    if (test->title)
...
int
iqperf_setaffinity(struct iqperf_test *test, int affinity)
{
...
int
iqperf_clearaffinity(struct iqperf_test *test)
{
#if defined(HAVE_SCHED_SETAFFINITY)
    cpu_set_t cpu_set;
    int i;
...
int
iqperf_printf(struct iqperf_test *test, const char* format, ...)
{
    va_list argp;
    int r = -1;
	...
	if (test->role == 's' && iqperf_get_test_get_server_output(test)) {
	    struct iqperf_textline *l = (struct iqperf_textline *) malloc(sizeof(struct iqperf_textline));
...
int
iflush(struct iqperf_test *test)
{
