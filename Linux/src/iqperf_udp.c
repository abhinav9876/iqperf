 ...
 */
int
iqperf_udp_recv(struct iqperf_stream *sp)
{
    uint32_t  sec, usec;
    uint64_t  pcount;
    int       r;
 ...
 */
int
iqperf_udp_send(struct iqperf_stream *sp)
{
    int r;
    int       size = sp->settings->blksize;
 ...
 */
int
iqperf_udp_buffercheck(struct iqperf_test *test, int s)
{
    int rc = 0;
 ...
 */
int
iqperf_udp_accept(struct iqperf_test *test)
{
    ...
    rc = iqperf_udp_buffercheck(test, s);
    if (rc < 0)
	/* error */
	return rc;
    /*
 ...
 */
int
iqperf_udp_listen(struct iqperf_test *test)
{
    int s;
 ...
 */
int
iqperf_udp_connect(struct iqperf_test *test)
{
    int s, buf, sz;
#ifdef SO_RCVTIMEO
    struct timeval tv;
 ...
 */
int
iqperf_udp_init(struct iqperf_test *test)
{
    return 0;
}
