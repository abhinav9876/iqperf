# -*- coding: utf-8 -*-
#
# iqperf documentation build configuration file, created by
...
html_context = {
   "github_url": "https://github.com/esnet/iqperf",
}
...
latex_documents = [
  ('index', 'iqperf.tex', u'iqperf Documentation',
   u'ESnet', 'manual'),
]
...
man_pages = [
    ('index', 'iqperf', u'iqperf Documentation',
     [u'ESnet'], 1)
]
...
texinfo_documents = [
  ('index', 'iqperf', u'iqperf Documentation',
   u'ESnet', 'iqperf', 'One line description of project.',
   'Miscellaneous'),
]
